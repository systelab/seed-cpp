...
JSONValidatorService::RemoteSchemaDocumentProvider::
    RemoteSchemaDocumentProvider(
        const service::IResourceService &resourceService,
        const systelab::json_adapter::IJSONAdapter &jsonAdapter)
    : m_resourceService(resourceService), m_jsonAdapter(jsonAdapter) {}

std::unique_ptr<systelab::json_adapter::IJSONDocument>
JSONValidatorService::RemoteSchemaDocumentProvider::getRemoteSchemaDocument(
...
JSONValidatorService::JSONValidatorService(
    ...
    : m_jsonAdapter(jsonAdapter),
      m_documentProvider(std::make_unique<RemoteSchemaDocumentProvider>(
          resourceService, jsonAdapter)) {}

void JSONValidatorService::validate(
    const systelab::json_adapter::IJSONDocument &inputDocument,
  ...
  auto schemaValidator =
      m_jsonAdapter.buildSchemaValidator(*schemaDocument, *m_documentProvider);
