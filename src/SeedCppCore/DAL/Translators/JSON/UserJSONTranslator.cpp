...
namespace seed_cpp { namespace dal {
	...
	void UserJSONSaveTranslator::saveEntityToJSON(systelab::json_adapter::IJSONValue& jsonUser) const
	{
	...
	std::string UserJSONSaveTranslator::translateRoleToString(model::User::Role role) const
	{
		...
		{
			throw std::exception("Unknown role");
		}
	}
	...
	void UserJSONLoadTranslator::loadEntityFromJSON(const systelab::json_adapter::IJSONValue& jsonUser)
	{
